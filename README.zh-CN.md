...
[Documentation](https://moonshotai.github.io/kimi-code/zh/) · [Issues](https://github.com/AGSQ11/kimi-code/issues) · [English](README.md)
...
- **源码构建** 从 GitHub 仓库克隆并构建，适合自定义扩展和持续跟进 fork 更新。
...
Kimi Code CLI 支持 [Agent Client Protocol](https://agentclientprotocol.com/)，ACP 兼容的编辑器 / IDE（Zed、JetBrains……）可以通过 stdio 直接驱动会话。登录一次后，把编辑器指向 `acp` 子命令即可，无需重复登录。
