export default {
  ...
  probeModelsTitle: '🔍 Model Probe Results',
  probeModelsNoModels: 'No models configured to probe.',
  probeModelsAllOk: 'All {count} model(s) reachable',
  probeModelsSummary: '{ok} reachable · {fail} unreachable',
