...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: '/memory',      desc: 'commands.memory.desc' },
  { name: '/criticize',   desc: 'commands.criticize.desc' },
  { name: '/compare',     desc: 'commands.compare.desc' },
  { name: '/spiceup',     desc: 'commands.spiceup.desc' },
  { name: '/mcp',         desc: 'commands.mcp.desc' },
  { name: '/forcemcp',    desc: 'commands.forcemcp.desc' },
  { name: '/plugins',     desc: 'commands.plugins.desc' },
  { name: '/experiments', desc: 'commands.experiments.desc' },
  { name: '/init',        desc: 'commands.init.desc' },
  { name: '/export',      desc: 'commands.export.desc' },
  { name: '/export-debug-zip', desc: 'commands.exportDebug.desc' },
  { name: '/feedback',    desc: 'commands.feedback.desc' },
  { name: '/version',     desc: 'commands.version.desc' },
  { name: '/reload',      desc: 'commands.reload.desc' },
  { name: '/reload-tui',  desc: 'commands.reloadTui.desc' },
  { name: '/reloadsysprompt', desc: 'commands.reloadSysPrompt.desc' },
